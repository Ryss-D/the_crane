...
- [ ] **LED-1 — Ledger + payments models, commission accrual** *(deps: JOB-2, JOB-3)*
...
- [ ] **LED-2 — Balance service + offer gating** *(deps: LED-1, DSP-1)*
...
- [ ] **LED-4 — Manual settlement recording** *(deps: LED-1)*
