...
- [x] **DSP-1 — Driver availability + Redis geo index** *(deps: AUTH-5)*
...
- [x] **DSP-2 — Sequential offer engine** *(deps: DSP-1, JOB-5)*
...
- [x] **DSP-3 — Accept endpoint + race safety** *(deps: DSP-2)*
...
- [x] **DSP-4 — Offer timeout worker** *(deps: DSP-2)*
...
- [x] **DSP-5 — No-drivers handling** *(deps: DSP-2)*
