...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,firebaseUid,role,name,phone,email,fcmToken);

@override
String toString() {
  return 'AppUser(id: $id, firebaseUid: $firebaseUid, role: $role, name: $name, phone: $phone, email: $email, fcmToken: $fcmToken)';
}
